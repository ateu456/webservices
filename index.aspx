  ...
  <body>
    ...
    <div id="pre-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <span>Tienda Online para Tí!!!</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="login.aspx">Inicio Seccion</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="banner">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="caption">
              <h2>Bienvenid@ Tienda Online</h2>
              <div class="line-dec"></div>
              <p>Gracias Por Visitarnos  <br/><br/> Esperando que tu experiencia con nosotros sea factible.</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="copyright-text">
              <p>Copyright &copy; 2021 Web Store  
